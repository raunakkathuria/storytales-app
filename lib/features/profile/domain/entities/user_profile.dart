...
class UserProfile extends Equatable {
  ...
  /// Total number of stories generated by user (lifetime).
  final int totalStoryCount;

  /// Maximum stories allowed for current tier (lifetime).
  final int maxTotalStories;
  ...
  UserProfile copyWith({
    ...
    return UserProfile(
      ...
      totalStoryCount: totalStoryCount ?? this.totalStoryCount,
      maxTotalStories: maxTotalStories ?? this.maxTotalStories,
  ...
  int get actualStoriesRemaining {
    ...
    // For free tier, calculate remaining from lifetime usage data
    final remaining = maxTotalStories - totalStoryCount;
